...
contract PresaleV3 is Initializable,  OwnableUpgradeable, ReentrancyGuardUpgradeable,PausableUpgradeable {
  ...
  function initialize() public initializer {
      ...
      stakeingWhitelistStatus = false;
      dynamicTimeFlag = true;

      // Set the USDT Interface and Aggregator addresses
      USDTInterface = IERC20Upgradeable(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd);
      aggregatorInterface = Aggregator(0x5ea7D6A33D3655F661C298ac8086708148883c34);
